...
# @typing.overload doesn't solve the problem of overloads
...
# Every object in Python has a type; `class` is a keyword which you use to
# construct types;
# A class definition is actually just syntactic sugar for a specific way of
# calling the type constructor;
B = type('B', (), {})
print(f'{B=}')
